...
export const tools: Tool[] = [
  ...
  { 
    ...
    introLines: [
      ...
      "2027年までは内閣府の公表内容に対応し、2028年以降は現行法と暦計算に基づく暫定値を使用します。",
  ...
  },
  {
    ...
    introLines: [
      ...
      "土日、国民の祝日、12月31日から1月3日までを窓口休業日として判定します。",
  ...
  },
  {
    ...
    introLines: [
      ...
      "2027年までは内閣府の公表内容に対応し、2028年以降の祝日は暫定値です。",
  ...
  { slug: "password-len-check", titleJa: "パスワード文字数チェック", descriptionJa: "パスワードの長さと強度を判定します。", category: "other", relatedSlugs: ["mynumber-check"] },
  {
    ...
    introLines: [
      ...
      "2027年までは内閣府公表済みの日付、2028年から2035年までは現行法と暦計算に基づく暫定日を表示します。",
    ],
    category: "other",
